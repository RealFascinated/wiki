...
import { useSectionStore } from "@/provider/section-provider";
...
export function Heading<Level extends 2 | 3>({
  ...
  return (
    <>
      ...
      <Eyebrow tag={tag} tagColor={tagColor} label={label} since={since} deprecated={deprecated} />
      <Component
        ref={ref}
        className={tag || label || since || deprecated ? "mt-2 scroll-mt-32" : "scroll-mt-24"}
        {...props}
      >
        {anchor ? (
