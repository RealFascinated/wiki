...
import { MobileNavigation, useIsInsideMobileNavigation } from "@/components/mobile-navigation";
      ...
      <div className="flex items-center gap-5">
        <nav className="hidden md:block">
          <ul role="list" className="flex items-center gap-8">
            <TopLevelNavItem href={config.socials.discord}>Support</TopLevelNavItem>
          </ul>
        </nav>
