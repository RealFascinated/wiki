  ...
  return (
    <div className="pointer-events-none absolute inset-0 mx-0 max-w-none overflow-hidden">
      <div className="absolute left-1/2 top-0 ml-[-38rem] h-[25rem] w-[81.25rem] dark:[mask-image:linear-gradient(white,transparent)]">
        <div className="absolute inset-0 bg-gradient-to-r from-[#6bbdf3] to-[#271d7f] opacity-40 [mask-image:radial-gradient(farthest-side_at_top,white,transparent)] dark:from-[#6bbdf3]/30 dark:to-[#271d7f]/30 dark:opacity-100">
          <GridPattern
            width={72}
            height={56}
            x={-12}
